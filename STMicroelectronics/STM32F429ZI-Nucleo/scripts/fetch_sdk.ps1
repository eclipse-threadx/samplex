...
$LibDir = Join-Path $BoardDir "lib/stm32cubef4"
$DriversDir = Join-Path $LibDir "Drivers"
$HalDest = Join-Path $DriversDir "STM32F4xx_HAL_Driver"
$CmsisDeviceDest = Join-Path $DriversDir "CMSIS/Device/ST/STM32F4xx"
$CmsisIncludeDest = Join-Path $DriversDir "CMSIS/Include"

Write-Host "=========================================="
Write-Host "STM32CubeF4 Standalone Driver Fetcher"
Write-Host "=========================================="
...
# 1. Fetch HAL Drivers
Write-Host "[INFO] Cloning STM32F4xx HAL Driver (depth=1)..."
git clone --depth 1 https://github.com/STMicroelectronics/stm32f4xx_hal_driver.git $TempDir
...
# 2. Fetch CMSIS Device F4
Write-Host "[INFO] Cloning CMSIS Device F4 (depth=1)..."
git clone --depth 1 https://github.com/STMicroelectronics/cmsis_device_f4.git $TempDir
if ($LASTEXITCODE -ne 0) {
...
Write-Host "=========================================="
Write-Host "[SUCCESS] STM32CubeF4 drivers successfully fetched!"
Write-Host "=========================================="
