...
LIB_DIR="${BOARD_DIR}/lib/stm32cubef4"
...
# 1. Fetch HAL Drivers
echo "[INFO] Cloning STM32F4xx HAL Driver (depth=1)..."
git clone --depth 1 https://github.com/STMicroelectronics/stm32f4xx_hal_driver.git "${TEMP_DIR}"
...
echo "[INFO] Cloning CMSIS Device F4 (depth=1)..."
git clone --depth 1 https://github.com/STMicroelectronics/cmsis_device_f4.git "${TEMP_DIR}"
